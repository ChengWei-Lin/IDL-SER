...
parser.add_argument("--model_name", type=str, default="CNN", help="Model name (CNN or ACNN, TransformerDualClassifier)")
parser.add_argument("--learning_rate", type=float, default=0.001, help="Learning rate")
parser.add_argument("--scheduler", type=str, default="ExponentialLR", help="Learning rate scheduler")
parser.add_argument("--gamma", type=float, default=0.95, help="Learning rate scheduler gamma")
...
def main(args):
    ...
    elif args.model_name == "TransformerDualClassifier":
    ...
    elif args.model_name == "BiLSTMModel":
        model = BiLSTMModel(
            input_dim=26, 
